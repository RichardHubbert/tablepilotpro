...
const mockTables: Table[] = [
  ...
  { id: 3, name: 'Table 3', capacity: 4, section: 'Center' },
  { id: 4, name: 'Table 4', capacity: 4, section: 'Center' },
  { id: 5, name: 'Table 5', capacity: 6, section: 'Patio' },
  { id: 6, name: 'Table 6', capacity: 6, section: 'Patio' },
];
